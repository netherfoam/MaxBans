...
public class TempRangeBanCommand extends CmdSkeleton{
	...
	public boolean run(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(overlap == null){
			plugin.getBanManager().announce(Formatter.secondary + banner + Formatter.primary + " banned " + Formatter.secondary + rb.toString() + Formatter.primary + ". Reason: '" + Formatter.secondary + reason + Formatter.primary + "' Remaining: " + Util.getTimeUntil(rb.getExpires()), silent, sender);
		}
		else{
